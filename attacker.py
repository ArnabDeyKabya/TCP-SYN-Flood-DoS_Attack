#!/usr/bin/env python3
"""
TCP SYN Flood + DoS tool with optional IP spoofing & multithreading (educational use only).
Builds and sends raw SYN packets, captures the server's SYN-ACK to verify connectivity.
"""
